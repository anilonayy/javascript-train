...
class UI
{
    ...
    {
        // If index is not in range assign the 0
...
class SongPlayer
{
    static Start()
    {
        ...
        musicInterval = setInterval(() => {
            ...
            {
                currentSongIndex++;
                this.NextSong(currentSongIndex);
            }
    ...
    static NextSong(index)
    {
        UI.DisplaySong(index);
        this.Start();
    }
...
musicSecondRange.addEventListener("change",function(e){
